...
--test_labels_loc '/scratch/shared/beegfs/hbull/repos/sign_finder/pointing_annotations/pointing.pkl' \
--test_only \
--resume 'checkpoints_pointing/checkpoints/model_0000004660.pt' \
--print_text_output "POINTING" \
--save_output_folder "pointing_intervals_vtt" \
--stride 16 \
--input_len 100 \
--threshold 0.5 \
--ff_size 768 \